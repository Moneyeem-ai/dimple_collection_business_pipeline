...
class Product(models.Model):
    ...
    article_number = models.CharField(max_length=128, null=True, blank=True, unique=True)
    size = models.CharField(max_length=128, null=True, blank=True, unique=True)
    wsp = models.CharField(max_length=128, null=True, blank=True, unique=True)
    mrp = models.CharField(max_length=128, null=True, blank=True, unique=True)
